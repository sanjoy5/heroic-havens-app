            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 py-14 items-center">
                ...
                <div class="bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    <form onSubmit={handleLogin} >
                        ...
                        <input type='submit' class="w-full my-4 text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg" value='Login' />
                        <p class="text-base text-gray-500 mt-3">New to Heroic Havens ? <Link to='/signup' className='text-blue-500'>Sign Up</Link>.</p>

                    </form>
                    <div className="divider">OR</div>
                    <button onClick={handleSignupWithGoogle} class=" text-white bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-900 rounded text-lg flex items-center justify-center gap-3 mt-4"> <BsGoogle className='text-xl' /> Login With Google</button>
                </div>
            </div>
        </div>
    );
