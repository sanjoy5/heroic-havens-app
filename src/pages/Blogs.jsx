                    ...
                    <div class="flex flex-wrap -m-12">
                        ...
                        <div class="p-12 w-full flex flex-col items-start">
                            <a class="inline-flex items-center mt-4">
                                <img alt="blog" src="https://i.ibb.co/34GxQTD/1677149097978-01.jpg" class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-top" />
                                <span class="flex-grow flex flex-col pl-4">
                                    <span class="title-font font-medium text-gray-900">Sanjoy Sarker</span>
                                    <span class="text-gray-400 text-xs tracking-widest mt-0.5">WEB DEVELOPER</span>
                                </span>
                            </a>
                            <h2 class="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-4">What is an access token and refresh token? How do they work and where should we store them on the client-side?</h2>
                            <p class="leading-relaxed mb-8">An access token is a security credential that allows a client such as a user or application to access protected resources on a server. It is usually short-lived and used for authorization purposes. On the other hand, a refresh token is a long-lived token used to obtain a new access token once the previous one expires. It helps prevent the need for users to re-enter their credentials frequently.
                                <br /><br />
                            ...
                            <div class="flex items-center flex-wrap pt-4 border-t-2 border-gray-100  w-full justify-between">
                                ...
                                <div className='flex items-center'>
                                    ...
                                    <span class="text-gray-400 mr-3 inline-flex items-center leading-none pr-3 py-1">
