        ...
        <div>
...

            {
                toys.length !== 0 ? (
                    ...
                    <>
                        <div className="w-full md:w-1/2 mx-auto my-16 bg-base-300 rounded text-center py-10 md:py-14 px-6 md:px-10">
                            <h2 className="text-2xl md:text-4xl text-bold mb-3">You Have no Toys Yet !</h2>
                            <p className="text-xl text-medium text-gray-600">Go and Add Some Toys...  <Link to='/add-toys' className="text-blue-500">Add Toys</Link> </p>
